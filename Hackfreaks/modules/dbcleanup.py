...
import Hackfreaks.modules.sql.global_bans_sql as gban_sql
import Hackfreaks.modules.sql.users_sql as user_sql
from Hackfreaks import DEV_USERS, OWNER_ID, dispatcher
