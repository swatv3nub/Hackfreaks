...
Can be found on telegram as [IGRISROBOT](https://t.me/MrHackfreaksRobot).
...
### Read these notes carefully before proceeding 
 ...
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot. [See this](https://github.com/swatv3nub/mrhackfreaks?blob/shiken/SaitamaRobot/__main__.py#L25)
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/swatv3nub/MrHackfreaks.git) 
