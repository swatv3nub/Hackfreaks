...
def arise(update: Update, context: CallbackContext):
    ...
    reply_photo = message.reply_to_message.reply_img if message.reply_to_message else message.reply_photo
    reply_photo(
        random.choice(fun_strings.IGRISPHOTO), caption=f'*arise! {name}*')                
