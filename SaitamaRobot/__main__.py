...
PM_START_TEXT = """
Hello {},The name's IGRIS

I am an 𝐴𝑛𝑖𝑚𝑒 Themed Group Managing Bot and I will help in managing your group

⚡ I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and banning system which safegaurds and helps your group from spammers 
...
🔗 [ Updates Channel ](https://t.me/IGRIS_CHANNAL)
✍ [ CONTACT For Queries ](https://t.me/HeLLxGodLike) 
...
IGRIS_IMG = "https://telegra.ph/file/aa8cf7ee43fa5917db13c.jpg"
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text(
            "Contact me in PM to get possible commands for IGRIS.",
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(
                    text="Help",
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 950898793 and DONATION_LINK:
            update.effective_message.reply_text(
